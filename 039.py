...
passou = idade - 18
if idade<=17:
    print(f'Você ainda não tem idade pra se alistar, daqui a {falta} anos vocẽ precisa-ra se alistar')
elif idade==8:
    print('Vocẽ ja tem idade pra se alistar')
elif idade>18:
    print(f'Já passou {passou} anos pra se alistar, eu começaria a correr se fosse você')